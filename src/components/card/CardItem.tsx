...
const CardItem = ({
  ...
  return (
    <div onClick={() => viewItem(item)} className="cursor-pointer xs:w-full sm:w-full md:w-full lg:w-full xl:w-[300px] 2xl:w-[400px]   group bg-[#242529] border-2 border-[#4d4d4f]  hover:bg-[#4d4d4f] transition duration-300 ease-out     rounded-lg flex flex-col gap-4 shadow-lg p-8">
